            ...
            >
                <div>
                    <NavLink to="/" className="flex flex-row items-center xl:gap-4 ">
                        <div>
                            <img src={Logo} alt="Logo" className="w-10 xl:w-18" />
                        </div>
                        <div className="hidden sm:block font-gilroy-semibold text-[1rem] xl:text-[1.6rem] xl:-translate-y-[0.1rem]">
                            <span className="text-[1.3rem] xl:text-[2rem] ">D</span>ivine{" "}
                            <span className="text-[1.3rem] xl:text-[1.8rem]">I</span>nnovative
                        </div>
                    </NavLink>
                </div>
                <div>
