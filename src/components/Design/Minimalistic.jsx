...
export default function Minimalistic(){
    return (
        <>
        <div className="hidden sm:block  sm:w-[45vw] md:w-[24rem] xl:w-[43vw] 2xl:w-[47rem] sm:h-[80vh] md:h-auto md:max-h-[36rem] xl:h-[150vh] 2xl:h-[72rem] mx-auto  xl:mx-8 sm:my-10 rounded-4xl sm:-translate-x-3 xl:translate-x-4   " id="Minimalistic-design">
                    <div className="">
                        <div className="absolute">
                            <img
                                src={Effect}
                                alt="effect img"
                                className="sm:w-[45vw] md:w-[24rem]  2xl:w-[47rem] sm:h-[80vh] md:h-auto md:max-h-[36rem] xl:h-[30rem] 2xl:h-[72rem]  rounded-4xl px-[0.1rem] object-cover "
                            />
                            <div className="">
                        ...
                        <img
                            src={gradient}
                            alt="gradient image"
                            className="w-[50vw] sm:w-[45vw] md:w-[24rem] 2xl:w-[47rem] sm:h-[80vh] md:h-auto md:max-h-[36rem] xl:h-[30rem] 2xl:h-[72rem]  rounded-4xl"
                        />
                    </div>
                </div>
        </>
