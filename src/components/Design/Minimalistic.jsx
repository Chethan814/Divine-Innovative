...
export default function Minimalistic(){
    return (
        <>
        <div className="hidden sm:block  sm:w-[45vw] xl:w-[43vw] 2xl:w-[47rem] sm:h-[80vh] xl:h-[150vh] 2xl:h-[72rem] mx-auto  xl:mx-8 sm:my-10 rounded-4xl sm:-translate-x-3 xl:translate-x-4   " id="Minimalistic-design">
                    <div className="">
