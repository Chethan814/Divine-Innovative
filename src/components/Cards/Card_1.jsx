            ...
            <div className="container mx-auto py- px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 font-gilroy ">
                    <div className="mt-12 md:mt-0 ">
                        <Fade delay={500} direction="up" triggerOnce={true}>
                            <img
                                src={image}
                                alt="About Us Image"
                    ...
                    <div className="max-w-lg">
                        <Fade delay={600} direction="up" triggerOnce={true}>
                            ...
                            <p className="mt-4 text-gray-600 text-lg">
                                We excel at transforming your ideas, thoughts,
                                and vision into custom web designs that showcase
                                your business and turn prospects into clients.
                                Our dedicated in-house team conducts thorough
                                analyses to craft designs that effectively
                                convey your business's identity, mission, and
                                vision.
                            </p>
                        </Fade>
                        <Fade delay={600} direction="down" triggerOnce={true}>
                            <div className="mt-8">
                                <NavLink
                                    to="aboutus"
